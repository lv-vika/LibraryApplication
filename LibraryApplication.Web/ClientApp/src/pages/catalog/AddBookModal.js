...
const AddBookModal = ({setShowModal, setBooks}) => {
    ...
    const onFinish = async (values) => {
        try {
            const {data: newBookId} = await API.post(`/api/Book/create`, {
                name: values.name,
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Form.Item name="isAvailable" label="Available" initialValue={true} valuePropName="checked">
                    <Switch/>
                </Form.Item>
                <Form.Item>
